#!/bin/bash
################################################################################
# ReconX Quick Start Example
# Demonstrates basic usage of ReconX
################################################################################

echo "ReconX Quick Start Examples"
echo "============================"
echo ""
...
echo "---------------------"
echo "Command: python3 reconx.py -t example.com"
...
echo "-------------------------"
echo "Command: python3 reconx.py -t example.com -p 1"
...
echo "---------------------------"
echo "Command: python3 reconx.py -t example.com,example.org -T 2"
...
echo "Command: python3 reconx.py -f targets_example.txt"
...
sqlite3 reconx.db "SELECT severity, COUNT(*) as count FROM vulnerabilities WHERE target='example.com' GROUP BY severity"

# Find all critical issues
sqlite3 reconx.db "SELECT tool, name, host FROM vulnerabilities WHERE target='example.com' AND severity='critical'"
EOF
echo ""
