...
class Vulnerability(Base):
    ...
    vuln_metadata = relationship("VulnerabilityMetadata", back_populates="vulnerability", uselist=False, lazy="select")
...
class VulnerabilityMetadata(Base):
    ...
    vulnerability = relationship("Vulnerability", back_populates="vuln_metadata", lazy="select")
...
class ThreatIntelData(Base):
    ...
    intel_metadata: Optional[str] = Column(String(2000), nullable=True)
